...
/** @type {string} */
const CACHE_VERSION = '1736391202|693365162';
/** @type {string} */
const CACHE_PREFIX = 'Flatland-RPG-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'Flatland-RPG.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["Flatland-RPG.html","Flatland-RPG.js","Flatland-RPG.offline.html","Flatland-RPG.icon.png","Flatland-RPG.apple-touch-icon.png","Flatland-RPG.worker.js","Flatland-RPG.audio.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHABLE_FILES = ["Flatland-RPG.wasm","Flatland-RPG.pck"];
